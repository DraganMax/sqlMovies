...
const CREATE_MOVIES_TABLE = `
  CREATE TABLE movies(
    ...
    budget_adj real not null,
    revenue_adj real not null
);
`;
...
describe("Tables", () => {
  ...
  it("should have correct columns and column types", async done => {
    ...
    expect(movies).toEqual([
      ...
      { name: "budget_adj", type: "real" },
      { name: "revenue_adj", type: "real" }
    ]);
  ...
  it("should have primary keys", async done => {
    ...
    expect(movies).toEqual([
      ...
      { name: "budget_adj", primaryKey: false },
      { name: "revenue_adj", primaryKey: false }
    ]);
  ...
  it("should have not null constraints", async done => {
    ...
    expect(movies).toEqual([
      ...
      { name: "budget_adj", notNull: true },
      { name: "revenue_adj", notNull: true }
    ]);
