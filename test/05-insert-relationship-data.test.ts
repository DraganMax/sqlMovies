...
const insertMovieGenres = (
  ...
  return (
    ...
    genres.map(genre => `
    (${movieId}, 
    '${genreRows.find(element => element.genre === genre)!.id.toString()}')`).join(",")
  );
};
...
const insertMovieActors = (
  ...
  return (`
    ...
    actors.map(actor => `
    (${movieId},
    '${actorRows.find(element => element.full_name === actor)!.id.toString()}')`).join(",")
    );
};
...
const insertMovieDirectors = (
  ...
  return (`
    ...
    (${movieId},
    '${directorRows.find(element => element.full_name === director)!.id.toString()}')`).join(",")
    );
};
...
const insertMovieKeywords = (
  ...
  return (`
    ...
    (${movieId},
    '${keywordRows.find(element => element.keyword === keyword)!.id.toString()}')`).join(",")
    );
};
...
const insertMovieProductionCompanies = (
  ...
  return (`
    ...
    (${movieId},
    '${productionCompanyRows.find(element => element.company_name === company)!.id.toString()}')`).join(",")
    );
};
